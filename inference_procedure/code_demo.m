...
tri_all_before = triangulation(delete,subset_all_before');
tri_all_after = triangulation(delete,subset_all_after');
delete2 = tri_all2_before.ConnectivityList;
...
quickscatter(subset_ob_after(:,iz));hold on; quickscatter(subset_all_after);
...
nexttile;quickscatter(subset_ob2_after(:,iz2));hold on; quickscatter(subset_all2_after);
